...
class Main {
     ...
     */
    private static ArrayList<Vertice> melhorativo2OPT(ArrayList<Vertice> saidaOut){
        boolean temOPT = true;
    ...
    private static ArrayList<Vertice> melhorativo3OPT(ArrayList<Vertice> saidaOut){
        boolean temOPT = true;
        int A, B, C, D, E , F;
        int ciclo = 0;
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(calculaPesoTotal(melhorativo2OPT(saidaVP)));      
    }
}
